...
export default function Gallery() {
  // Duplicate images for infinite scroll on mobile
  const mobileImages = [...images, ...images];

  return (
    <div className="bg-navy overflow-hidden">
      {/* Mobile Auto-Scroll (Ticker style) */}
      <div className="md:hidden">
        ...
        >
          {mobileImages.map((src, i) => (
            <div key={i} className="relative w-1/3 shrink-0 aspect-[3/5] overflow-hidden">
              <img
                src={src}
                alt="Gallery image"
                loading="lazy"
      ...
      <div className="hidden md:grid grid-cols-6 h-[320px] gap-[3px]">
        {images.map((src, i) => (
