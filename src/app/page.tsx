          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-7 shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#25D366] text-white py-3.5 rounded-xl font-jost text-[11px] font-bold tracking-[2px] uppercase no-underline transition-all duration-300 hover:bg-white hover:text-[#25D366]"
              >
